export default {
  active: true,
  id: "gumotex",
  name: "3D vizualizace nového typu lodi",
  client: "Gumotex",
  tags: ["print", "3D"],
  ...
  presentation: {
    0: [
      {
        videoVimeoId: "366970306"
      }
    ],
    1: [
      {
        blockquote:
          "Inspiraci pro naše projekty hledáme všude kolem. Pro simulaci vláken lodi jsme hledali inspiraci v přírodě, růstu rostlin a v dalších organických strukturách."
      }
    ],
    2: [
      {
