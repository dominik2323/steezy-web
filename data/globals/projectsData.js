export default [
  {
    active: true,
    id: 'dropDnd',
    name: 'Aukční aplikace pro Dubai',
    client: 'Drop DnD',
  ...
  },
  {
    ...
    id: 'surgeryClinic',
    name:
      'Start-up ze Sillicon Valley ve spolupráci s přední sportovní klinikou z Dublinu',
    client: 'Sport Surgery Clinic Dublin',
    tags: ['video', 'dublin', 'sport'],
