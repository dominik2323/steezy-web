export default {
  ...
  grid: {
    0: [{ img: "00.jpg", alt: "smth" }, { img: "01.jpg", alt: "smth" }],
    1: [{ img: "02.jpg", alt: "smth" }],
    2: [{ img: "03.jpg", alt: "smth" }, { img: "04.jpg", alt: "smth" }],
    3: [
      {
        blockquote:
          "Výraz “steezy” má původ v prostředí extremních sportů, kterým se aktivně věnujeme. Bývá tak označován technicky velmi složitý trik, který je provedený s\u00a0takovou lehkostí a\u00a0stylem, že navenek vypadá úplně přirozeně a\u00a0jednoduše."
      }
    ],
    4: [{ img: "05.jpg", alt: "smth" }],
    5: [{ img: "06.jpg", alt: "smth" }, { img: "07.jpg", alt: "smth" }],
    6: [{ img: "08.jpg", alt: "smth" }],
    7: [{ img: "09.jpg", alt: "smth" }, { img: "10.jpg", alt: "smth" }],
    8: [{ img: "11.jpg", alt: "smth" }, { img: "12.jpg", alt: "smth" }],
    9: [
      {
        blockquote:
