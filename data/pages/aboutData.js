export default {
  ...
  grid: {
    0: [{ img: '01.png', alt: 'smth' }, { img: '02.png', alt: 'smth' }],
    1: [{ img: '03.png', alt: 'smth' }],
    2: [{ img: '04.png', alt: 'smth' }, { img: '05.png', alt: 'smth' }],
    3: [{ img: '06.png', alt: 'smth' }],
    4: [{ img: '07.png', alt: 'smth' }, { img: '08.png', alt: 'smth' }],
    5: [{ img: '09.png', alt: 'smth' }],
    6: [{ img: '10.png', alt: 'smth' }, { img: '11.png', alt: 'smth' }]
  }
};
