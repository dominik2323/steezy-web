export default {
  ...
  grid: {
    0: [{ img: '00.png', alt: 'smth' }, { img: '01.png', alt: 'smth' }],
    1: [{ img: '02.png', alt: 'smth' }],
    2: [{ img: '03.png', alt: 'smth' }, { img: '04.png', alt: 'smth' }],
    3: [
      {
        blockquote:
    ...
    4: [{ img: '05.png', alt: 'smth' }],
    5: [{ img: '06.png', alt: 'smth' }, { img: '07.png', alt: 'smth' }],
    6: [{ img: '08.png', alt: 'smth' }],
    7: [{ img: '09.png', alt: 'smth' }, { img: '10.png', alt: 'smth' }],
    8: [{ img: '11.png', alt: 'smth' }, { img: '12.png', alt: 'smth' }],
    9: [
      {
        blockquote:
